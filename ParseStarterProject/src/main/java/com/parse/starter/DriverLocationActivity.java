...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void acceptRequest(View view) {
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null) {
                    if (objects.size() > 0) {
                        Toast.makeText(DriverLocationActivity.this, "kkkkkkk", Toast.LENGTH_SHORT).show();
                        for (ParseObject object: objects) {
                            ...
                            object.saveInBackground(new SaveCallback() {
                                ...
                                public void done(ParseException e) {
                                    ...
                                    if(e == null) {
                                        Toast.makeText(DriverLocationActivity.this, "hahahaha", Toast.LENGTH_LONG).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng requestLocation = new LatLng(intent.getDoubleExtra("requestLatitude", 0), getIntent().getDoubleExtra("requestLongitude", 0));
